...
#Daily Purposes export
PeakHours = [ "DAY" ]
Purposes = [ "HBEB_PT" , "HBW_PT" , "HBO_PT" , "NHBEB_PT" , "NHBO_PT" , "TOTAL_PT" ]

output_file = r"\\sweco.se\gb\LDS01\Legacy\LND\65204376 Worcestershire Strategic Transport Model\05 Design and Calc\03_StrategicModelling\BaseYear\DemandModel\RealismTests\Outputs\PT_Fare_Update_Log.csv"
...
#Peak hour Purposes export
PeakHours = [ "AM" , "IP" , "PM" ]
Purposes = [ "EB" , "W" , "O" ]

for peak in PeakHours:
    for purpose in Purposes:
        if( "DE_{}_{}_PT".format(purpose,peak) in all_network_attributes ):
            
            DemandElasticity_CurrentIteration["DE_{}_{}_PT".format(purpose,peak)] = Visum.Net.AttValue("DE_{}_{}_PT".format(purpose,peak))


#enter the matrix numbers to be exported to csv file
matrix_set = [ '3073', '3074', '3075', '3076', '3077', '3127', '3128', '3129', '3130', '3131', '3132', '3133', '3134', '3135' , '6020' , '6021' , '6022' , '6023' , '6024' ,
